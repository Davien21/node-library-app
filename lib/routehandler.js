...
routeHandler._books.post = (data, callback) => {
    ...
    if(name && price && author && publisher && quantity){
        ...
        console.log(name,price,author,publisher,quantity)
        console.log(data.payload)
         callback(400, { message: "Please fill in all required details : name, price, author, publisher and quantity of this book" });
    }
};
